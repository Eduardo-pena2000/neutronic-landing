...
export default function Hero() {
  ...
  return (
    <section id="home" ref={ref} className="grid grid-cols-1 md:grid-cols-2 items-center gap-12 py-20 min-h-[80vh] relative overflow-hidden">
      ...
      />
      <motion.div
        className="absolute -bottom-40 -right-40 w-96 h-96 bg-pink-500/10 rounded-full blur-3xl pointer-events-none"
      ...
      >
        ...
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
          <div className="w-64 h-64 bg-gradient-to-r from-cyan-500/20 to-pink-500/20 rounded-full blur-3xl animate-pulse" />
        </div>
        <AnimatedAtom />
      </motion.div>
    </section>
